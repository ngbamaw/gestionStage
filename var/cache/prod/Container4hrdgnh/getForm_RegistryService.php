...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\ModifyProfessorType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ModifyProfessorType']) ? $this->services['AppBundle\\Form\\ModifyProfessorType'] : ($this->services['AppBundle\\Form\\ModifyProfessorType'] = new \AppBundle\Form\ModifyProfessorType())) && false ?: '_'};
}, 'AppBundle\\Form\\ModifyStudiantType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ModifyStudiantType']) ? $this->services['AppBundle\\Form\\ModifyStudiantType'] : ($this->services['AppBundle\\Form\\ModifyStudiantType'] = new \AppBundle\Form\ModifyStudiantType())) && false ?: '_'};
}, 'AppBundle\\Form\\SignupProfessorType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\SignupProfessorType']) ? $this->services['AppBundle\\Form\\SignupProfessorType'] : ($this->services['AppBundle\\Form\\SignupProfessorType'] = new \AppBundle\Form\SignupProfessorType())) && false ?: '_'};
}, 'AppBundle\\Form\\SignupStudiantType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\SignupStudiantType']) ? $this->services['AppBundle\\Form\\SignupStudiantType'] : ($this->services['AppBundle\\Form\\SignupStudiantType'] = new \AppBundle\Form\SignupStudiantType())) && false ?: '_'};
}, 'AppBundle\\Form\\SignupUserType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\SignupUserType']) ? $this->services['AppBundle\\Form\\SignupUserType'] : ($this->services['AppBundle\\Form\\SignupUserType'] = new \AppBundle\Form\SignupUserType())) && false ?: '_'};
