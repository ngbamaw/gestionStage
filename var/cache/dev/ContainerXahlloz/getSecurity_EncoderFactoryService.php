...
return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(['app_encoder' => ${($_ = isset($this->services['app.password_encoder']) ? $this->services['app.password_encoder'] : ($this->services['app.password_encoder'] = new \AppBundle\Service\PasswordEncoder())) && false ?: '_'}]);
